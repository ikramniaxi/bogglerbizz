    ...
    if (sizeof($sessions) > 0) {
        foreach ($sessions as $key => $session) {
            ...
            //         </li>';
              ...
              $html.='  <li  class="nav-item session" sid="'.$session->id.'">
              <div class="row p-2">
                  <img src="'.asset('avatars/'.Auth::user()->assistant_avatar).'" alt="" class="col-3">
                  <div class="widget-subheading col-9 d-flex " style="    justify-content: center;
                  align-items: center;
                  margin-left: -15px;
                  font-size: 15px;
                  font-weight: 500;
                  " >
                     <p class="col-12 d-block" style="font-size: 14px"> '.ucfirst($session->session_name).'
                      <span style="position: absolute;margin-right:0px;margin-left:10px" classs="delSess"  sid="'.$session->id.'"><i class="fa fa-times"></i></span>
