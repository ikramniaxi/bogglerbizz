                    ...
                    <div class="col-lg-5 col-md-10">
                        <div class="login-content">
                            ...
                            <form method="post" action="{{ route('login') }}">
                                @csrf
                                <div class="form-grp"><label for="email">Your Email</label> <input id="email"
                                ...
                                <button class="sine-btn" type="submit">Sign in</button>
                                <button class="google-btn" type="submit">
                                    <a href="{{ route('google.redirect') }}"><img alt="" src="frontend/img/images/google.png" />&nbsp;Sign in with
                                    google</button></a>
                                    
                                    <span>Don&acirc;&euro;&trade;t have an account?
