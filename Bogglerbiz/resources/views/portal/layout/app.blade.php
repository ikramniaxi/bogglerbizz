...
--}}
                            <div class="header-right-option dropdown profile-nav-item pt-0 pb-0">
                                <a class="dropdown-item dropdown-toggle avatar d-flex align-items-center" href="#"
                                    ...
                                    aria-expanded="false">
                                    <img src="{{ Storage::url(auth()->user()->my_avatar)?? '/assets/images/user/user-1.png' }}" alt="avatar">
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdown-header d-flex flex-column align-items-center">
                                        <div class="figure mb-3">
                                            <img src="{{ Storage::url(auth()->user()->my_avatar)?? '/assets/images/user/user-1.png' }}" class="rounded-circle"
                                                alt="avatar">
                                        </div>
                ...
                <ul id="sidebar-menu" class="sidebar-menu">
                    ...
                    <li class="{{ request()->routeIs('users.feedback') ? 'mm-active' : '' }}">
                        <a href="{{ route('users.feedback') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <img src="{{ asset('assets/images/icon/activities.svg') }}" alt="profile-2user">
                            </div>
                    ...
                    <li class="{{ request()->routeIs('widget') ? 'mm-active' : '' }}">
                        <a href="{{ route('widget') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <img src="{{ asset('assets/images/icon/widget.svg') }}" alt="profile-2user">
                            </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="https://templates.Boggler.com/joxi/default/"
                                class="default-btn active me-1">LTR</a>
                            <a href="https://templates.Boggler.com/joxi/rtl/" class="default-btn ms-1">RTL</a>
                        </div>
                    </li>
                    <li>
