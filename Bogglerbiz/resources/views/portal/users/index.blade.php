                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-success" onclick="window.location.reload()"><span><i class="fa-solid fa-repeat"></i></span> Reload Users
                            </button>
                            <a href="{{route('users.create')}}" class="btn btn-primary mx-1">
