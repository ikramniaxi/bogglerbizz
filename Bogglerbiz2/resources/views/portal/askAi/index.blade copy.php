                ...
                <div class="col">
                    <div class="row d-flex justify-content-space-between" style="justify-content: space-between;">
                        ...
                        <div style="width: 200px">
                            ...
                            <span style="padding: 10px;background:royalblue;border-radius:60%;color:white"><img
                        ...
                        <form class="p-0" id="chatForm" method="post" onsubmit="return false;">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="textarea-container row" style="position: relative;">
                                        ...
                                        <button type="submit" class="leftsubBtn" id="sendMsg"
                                            ...
                                            <i class="fa-solid fa-file-arrow-up" style="font-size: 30px;color:#146ebe"></i>
                                        </button>
                                    </div>
...
@section('page-js-script')
    ...
    <script>
        ...
        function sendMsg(msg) {
            ...
            appendMsg(msg, "<?= asset('avatars/' . Auth::user()->my_avatar) ?>", 'GPT Assistant', 'right');
            ...
            var Myimg = "<?= asset('avatars/' . Auth::user()->my_avatar) ?>";
            var botPic = "<?= asset('avatars/' . Auth::user()->assistant_avatar) ?>";
        ...
        function appendMsg(msg, Myimg, name, position, aimodel = 'text', status = 200) {
            ...
            if (position === 'right') {
                ...
                chatContainer.append('<div class="chat-box-wrapper d-flex align-items-start gap-2 mt-3">' +
                    ...
                    '<img src="<?= asset('avatars/' . Auth::user()->assistant_avatar) ?>" alt="" style="height:40px !important;width:40px !important;"/>' +
                    '</div>' +
                    '</div>' +
                    '</div>' +
                    '<div class="w-75">' +
    ...
    if (Auth::user()->first_visit == 1): ?>
        ...
        function setTyping() {
            let botPicture = "<?= asset('avatars/' . Auth::user()->assistant_avatar) ?>";
            $("#chatArea").append(
                '<div class="d-flex gap-2" id="typ">' +
                '<div><img src="<?= asset('avatars/' . Auth::user()->assistant_avatar) ?>" width="40px" height="40px"/></div> <div id="typing" class="typingIndicatorContainer chat-box-wrapper"><div class="typingIndicatorBubble"><div class="typingIndicatorBubbleDot"></div><div class="typingIndicatorBubbleDot"></div><div class="typingIndicatorBubbleDot"></div>' +
                '</div></div></div>')
            goDown();
        }
